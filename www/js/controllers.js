...
.controller('StockCtrl', ['$scope','$window', '$stateParams', 'stockDataService', 'dateService', 'chartDataService',
   function($scope, $window, $stateParams, stockDataService, dateService, chartDataService) {
